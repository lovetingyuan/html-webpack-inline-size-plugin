...
var pluginName = 'HtmlWebpackInlineSizePlugin';
...
var HtmlWebpackInlineSizePlugin = function () {
  function HtmlWebpackInlineSizePlugin(options) {
    ...
    _assert2.default.equal(options, undefined, pluginName + ' does not accept any options');
  }
    ...
    value: function apply(compiler) {
      ...
      if (compiler.hooks) {
        compiler.hooks.compilation.tap(pluginName, function (compilation) {
          compilation.hooks.htmlWebpackPluginBeforeHtmlGeneration.tapAsync(pluginName, function () {
